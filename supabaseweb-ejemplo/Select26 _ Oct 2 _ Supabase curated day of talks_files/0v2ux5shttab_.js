(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,46822,87599,e=>{"use strict";var t=e.i(91614);let i=`#version 300 es
...
}`;function n(e){if(e.naturalWidth<1024&&e.naturalHeight<1024){if(e.naturalWidth<1||e.naturalHeight<1)return;let t=e.naturalWidth/e.naturalHeight;e.width=Math.round(t>1?1024*t:1024),e.height=Math.round(t>1?1024:1024/t)}}e.s(["ShaderMount",0,r,"isPaperShaderElement",0,function(e){return"paperShaderMount"in e}],87599);var l=e.i(52795);async function A(e){let t={},i=[];return Object.entries(e).forEach(([e,o])=>{if("string"==typeof o){let r=o||"data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";if(!(e=>{try{if(e.startsWith("/"))return!0;return new URL(e),!0}catch{return!1}})(r))return void console.warn(`Uniform "${e}" has invalid URL "${r}". Skipping image loading.`);let a=new Promise((i,o)=>{let a=new Image;(e=>{try{if(e.startsWith("/"))return!1;return new URL(e,window.location.origin).origin!==window.location.origin}catch{return!1}})(r)&&(a.crossOrigin="anonymous"),a.onload=()=>{n(a),t[e]=a,i()},a.onerror=()=>{console.error(`Could not set uniforms. Failed to load image at ${r}`),o()},a.src=r});i.push(a)}else o instanceof HTMLImageElement&&n(o),t[e]=o}),await Promise.all(i),t}let c=(0,t.forwardRef)(function({fragmentShader:e,uniforms:i,webGlContextAttributes:o,speed:a=0,frame:s=0,width:n,height:c,minPixelRatio:u,maxPixelCount:h,mipmaps:g,style:f,...p},m){var d;let v,B,[x,w]=(0,t.useState)(!1),E=(0,t.useRef)(null),S=(0,t.useRef)(null),Q=(0,t.useRef)(o);(0,t.useEffect)(()=>((async()=>{let t=await A(i);E.current&&!S.current&&(S.current=new r(E.current,e,t,Q.current,a,s,u,h,g),w(!0))})(),()=>{S.current?.dispose(),S.current=null}),[e]),(0,t.useEffect)(()=>{let e=!1;return(async()=>{let t=await A(i);e||S.current?.setUniforms(t)})(),()=>{e=!0}},[i,x]),(0,t.useEffect)(()=>{S.current?.setSpeed(a)},[a,x]),(0,t.useEffect)(()=>{S.current?.setMaxPixelCount(h)},[h,x]),(0,t.useEffect)(()=>{S.current?.setMinPixelRatio(u)},[u,x]),(0,t.useEffect)(()=>{S.current?.setFrame(s)},[s,x]);let C=(d=[E,m],v=t.useRef(void 0),B=t.useCallback(e=>{let t=d.map(t=>{if(null!=t){if("function"==typeof t){let i=t(e);return"function"==typeof i?i:()=>{t(null)}}return t.current=e,()=>{t.current=null}}});return()=>{t.forEach(e=>e?.())}},d),t.useMemo(()=>d.every(e=>null==e)?null:e=>{v.current&&(v.current(),v.current=void 0),null!=e&&(v.current=B(e))},d));return(0,l.jsx)("div",{ref:C,style:void 0!==n||void 0!==c?{width:"string"==typeof n&&!1===isNaN(+n)?+n:n,height:"string"==typeof c&&!1===isNaN(+c)?+c:c,...f}:f,...p})});c.displayName="ShaderMount",e.s(["ShaderMount",0,c],46822)},83398,e=>{"use strict";e.s(["colorPropsAreEqual",0,function(e,t){for(let i in e){if("colors"===i){let i=Array.isArray(e.colors),o=Array.isArray(t.colors);if(!i||!o){if(!1===Object.is(e.colors,t.colors))return!1;continue}if(e.colors?.length!==t.colors?.length||!e.colors?.every((e,i)=>e===t.colors?.[i]))return!1;continue}if(!1===Object.is(e[i],t[i]))return!1}return!0}])},40622,e=>{"use strict";e.s(["ShaderFitOptions",0,{none:0,contain:1,cover:2},"defaultObjectSizing",0,{fit:"contain",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},"defaultPatternSizing",0,{fit:"none",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0}])},82728,e=>{"use strict";let t=(e,t,i)=>Math.min(Math.max(e,t),i),i=[0,0,0,1];e.s(["getShaderColorFromString",0,function(e){if(Array.isArray(e))return 4===e.length?e:3===e.length?[...e,1]:i;if("string"!=typeof e)return i;let o,r,a,s=1;if(e.startsWith("#")){var n;[o,r,a,s]=(3===(n=(n=e).replace(/^#/,"")).length&&(n=n.split("").map(e=>e+e).join("")),6===n.length&&(n+="ff"),[parseInt(n.slice(0,2),16)/255,parseInt(n.slice(2,4),16)/255,parseInt(n.slice(4,6),16)/255,parseInt(n.slice(6,8),16)/255])}else if(e.startsWith("rgb")){let t;[o,r,a,s]=(t=e.match(/^rgba?\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(t[1]??"0")/255,parseInt(t[2]??"0")/255,parseInt(t[3]??"0")/255,void 0===t[4]?1:parseFloat(t[4])]:[0,0,0,1]}else{let t;if(!e.startsWith("hsl"))return console.error("Unsupported color format",e),i;[o,r,a,s]=function(e){let t,i,o,[r,a,s,n]=e,l=r/360,A=a/100,c=s/100;if(0===a)t=i=o=c;else{let e=(e,t,i)=>(i<0&&(i+=1),i>1&&(i-=1),i<1/6)?e+(t-e)*6*i:i<.5?t:i<2/3?e+(t-e)*(2/3-i)*6:e,r=c<.5?c*(1+A):c+A-c*A,a=2*c-r;t=e(a,r,l+1/3),i=e(a,r,l),o=e(a,r,l-1/3)}return[t,i,o,n]}((t=e.match(/^hsla?\s*\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*(?:,\s*([0-9.]+))?\s*\)$/i))?[parseInt(t[1]??"0"),parseInt(t[2]??"0"),parseInt(t[3]??"0"),void 0===t[4]?1:parseFloat(t[4])]:[0,0,0,1])}return[t(o,0,1),t(r,0,1),t(a,0,1),t(s,0,1)]}])},2207,e=>{"use strict";let t=`
...
`;e.s(["colorBandingFix",0,n,"declarePI",0,t,"fiberNoise",0,A,"proceduralHash11",0,o,"proceduralHash21",0,r,"rotation2",0,i,"simplexNoise",0,l,"textureRandomizerGB",0,s,"textureRandomizerR",0,a])},59918,68138,e=>{"use strict";var t=e.i(91614),i=e.i(46822),o=e.i(83398),r=e.i(40622),a=e.i(82728),s=e.i(2207);let n={maxColorCount:10},l=`#version 300 es
precision mediump float;
...
`;e.s(["GrainGradientShapes",0,{wave:1,dots:2,truchet:3,corners:4,ripple:5,blob:6,sphere:7},"grainGradientFragmentShader",0,o,"grainGradientMeta",0,i])},82737,e=>{"use strict";var t=e.i(91614),i=e.i(46822),o=e.i(82728),r=e.i(39484),a=e.i(45867),s=e.i(40622),n=e.i(52795);let l={name:"Default",params:{...s.defaultObjectSizing,speed:1,frame:0,colorBack:"#000000",colors:["#7300ff","#eba8ff","#00bfff","#2a00ff"],softness:.5,intensity:.5,noise:.25,shape:"corners"}},A=[l,{name:"Wave",params:{...s.defaultPatternSizing,speed:1,frame:0,colorBack:"#000a0f",colors:["#c4730b","#bdad5f","#d8ccc7"],softness:.7,intensity:.15,noise:.5,shape:"wave"}},{name:"Dots",params:{...s.defaultPatternSizing,scale:.6,speed:1,frame:0,colorBack:"#0a0000",colors:["#6f0000","#0080ff","#f2ebc9","#33cc33"],softness:1,intensity:1,noise:.7,shape:"dots"}},{name:"Truchet",params:{...s.defaultPatternSizing,speed:1,frame:0,colorBack:"#0a0000",colors:["#6f2200","#eabb7c","#39b523"],softness:0,intensity:.2,noise:1,shape:"truchet"}},{name:"Ripple",params:{...s.defaultObjectSizing,scale:.5,speed:1,frame:0,colorBack:"#140a00",colors:["#6f2d00","#88ddae","#2c0b1d"],softness:.5,intensity:.5,noise:.5,shape:"ripple"}},{name:"Blob",params:{...s.defaultObjectSizing,scale:1.3,speed:1,frame:0,colorBack:"#0f0e18",colors:["#3e6172","#a49b74","#568c50"],softness:0,intensity:.15,noise:.5,shape:"blob"}}],c=(0,t.memo)(function({speed:e=l.params.speed,frame:t=l.params.frame,colorBack:A=l.params.colorBack,colors:c=l.params.colors,softness:u=l.params.softness,intensity:h=l.params.intensity,noise:g=l.params.noise,shape:f=l.params.shape,fit:p=l.params.fit,scale:m=l.params.scale,rotation:d=l.params.rotation,originX:v=l.params.originX,originY:B=l.params.originY,offsetX:x=l.params.offsetX,offsetY:w=l.params.offsetY,worldWidth:E=l.params.worldWidth,worldHeight:S=l.params.worldHeight,...Q}){let C={u_colorBack:(0,o.getShaderColorFromString)(A),u_colors:c.map(o.getShaderColorFromString),u_colorsCount:c.length,u_softness:u,u_intensity:h,u_noise:g,u_shape:a.GrainGradientShapes[f],u_noiseTexture:(0,r.getShaderNoiseTexture)(),u_fit:s.ShaderFitOptions[p],u_scale:m,u_rotation:d,u_offsetX:x,u_offsetY:w,u_originX:v,u_originY:B,u_worldWidth:E,u_worldHeight:S};return(0,n.jsx)(i.ShaderMount,{...Q,speed:e,frame:t,fragmentShader:a.grainGradientFragmentShader,uniforms:C})});e.s(["GrainGradient",0,c,"grainGradientPresets",0,A])}]);