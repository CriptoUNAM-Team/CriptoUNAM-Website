(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,49897,o=>{"use strict";var e=o.i(46822),a=o.i(59918),t=o.i(91614),r=o.i(83398),i=o.i(40622),s=o.i(82728),l=o.i(39484),n=o.i(2207);let f={maxColorCount:10,maxNoiseIterations:8},c=`#version 300 es
...
`,v={name:"Default",params:{...i.defaultPatternSizing,speed:1,frame:0,colorFront:"#ffffff",colorMid:"#47a6ff",colorBack:"#000000",brightness:.05,contrast:.3}},_=[v,{name:"Sensation",params:{...i.defaultPatternSizing,speed:1,frame:0,colorFront:"#00c8ff",colorMid:"#fbff00",colorBack:"#8b42ff",brightness:.19,contrast:.12,scale:3}},{name:"Bloodstream",params:{...i.defaultPatternSizing,speed:1,frame:0,colorFront:"#ff0000",colorMid:"#ff0000",colorBack:"#ffffff",brightness:.24,contrast:.17,scale:.7}},{name:"Ghost",params:{...i.defaultPatternSizing,speed:1,frame:0,colorFront:"#ffffff",colorMid:"#000000",colorBack:"#ffffff",brightness:0,contrast:1,scale:.55}}],x=(0,t.memo)(function({speed:o=v.params.speed,frame:a=v.params.frame,colorFront:t=v.params.colorFront,colorMid:r=v.params.colorMid,colorBack:l=v.params.colorBack,brightness:n=v.params.brightness,contrast:f=v.params.contrast,fit:c=v.params.fit,scale:m=v.params.scale,rotation:p=v.params.rotation,originX:d=v.params.originX,originY:g=v.params.originY,offsetX:_=v.params.offsetX,offsetY:x=v.params.offsetY,worldWidth:y=v.params.worldWidth,worldHeight:b=v.params.worldHeight,...S}){let C={u_colorFront:(0,s.getShaderColorFromString)(t),u_colorMid:(0,s.getShaderColorFromString)(r),u_colorBack:(0,s.getShaderColorFromString)(l),u_brightness:n,u_contrast:f,u_fit:i.ShaderFitOptions[c],u_scale:m,u_rotation:p,u_offsetX:_,u_offsetY:x,u_originX:d,u_originY:g,u_worldWidth:y,u_worldHeight:b};return(0,u.jsx)(e.ShaderMount,{...S,speed:o,frame:a,fragmentShader:h,uniforms:C})},r.colorPropsAreEqual),y={maxColorCount:10},b=`#version 300 es
precision mediump float;
...
`,B={circle:0,diamond:1,square:2,triangle:3},U={name:"Default",params:{...i.defaultPatternSizing,colorBack:"#000000",colorFill:"#ffffff",colorStroke:"#ffaa00",size:2,gapX:32,gapY:32,strokeWidth:0,sizeRange:0,opacityRange:0,shape:"circle"}},V=[U,{name:"Triangles",params:{...i.defaultPatternSizing,colorBack:"#ffffff",colorFill:"#ffffff",colorStroke:"#808080",size:5,gapX:32,gapY:32,strokeWidth:1,sizeRange:0,opacityRange:0,shape:"triangle"}},{name:"Tree line",params:{...i.defaultPatternSizing,colorBack:"#f4fce7",colorFill:"#052e19",colorStroke:"#000000",size:8,gapX:20,gapY:90,strokeWidth:0,sizeRange:1,opacityRange:.6,shape:"circle"}},{name:"Wallpaper",params:{...i.defaultPatternSizing,colorBack:"#204030",colorFill:"#000000",colorStroke:"#bd955b",size:9,gapX:32,gapY:32,strokeWidth:1,sizeRange:0,opacityRange:0,shape:"diamond"}}],O=(0,t.memo)(function({colorBack:o=U.params.colorBack,colorFill:a=U.params.colorFill,colorStroke:t=U.params.colorStroke,size:r=U.params.size,gapX:l=U.params.gapX,gapY:n=U.params.gapY,strokeWidth:f=U.params.strokeWidth,sizeRange:c=U.params.sizeRange,opacityRange:m=U.params.opacityRange,shape:p=U.params.shape,fit:d=U.params.fit,scale:g=U.params.scale,rotation:h=U.params.rotation,originX:v=U.params.originX,originY:_=U.params.originY,offsetX:x=U.params.offsetX,offsetY:y=U.params.offsetY,worldWidth:b=U.params.worldWidth,worldHeight:S=U.params.worldHeight,maxPixelCount:C=0x136a400,...w}){let k={u_colorBack:(0,s.getShaderColorFromString)(o),u_colorFill:(0,s.getShaderColorFromString)(a),u_colorStroke:(0,s.getShaderColorFromString)(t),u_dotSize:r,u_gapX:l,u_gapY:n,u_strokeWidth:f,u_sizeRange:c,u_opacityRange:m,u_shape:B[p],u_fit:i.ShaderFitOptions[d],u_scale:g,u_rotation:h,u_offsetX:x,u_offsetY:y,u_originX:v,u_originY:_,u_worldWidth:b,u_worldHeight:S};return(0,u.jsx)(e.ShaderMount,{...w,maxPixelCount:C,fragmentShader:z,uniforms:k})},r.colorPropsAreEqual),F={maxColorCount:10},M=`#version 300 es
precision mediump float;
...
`,R={name:"Default",params:{...i.defaultPatternSizing,scale:.6,speed:.5,frame:0,colors:["#4449CF","#FFD1E0","#F94446","#FFD36B","#FFFFFF"],stepsPerColor:2,softness:0}},I={name:"Bubblegum",params:{...i.defaultPatternSizing,speed:2,frame:0,colors:["#ffffff","#ff9e9e","#5f57ff","#00f7ff"],stepsPerColor:1,softness:1,scale:1.6}},P=[R,{name:"Spots",params:{...i.defaultPatternSizing,speed:.6,frame:0,colors:["#ff7b00","#f9ffeb","#320d82"],stepsPerColor:1,softness:0,scale:1}},{name:"First contact",params:{...i.defaultPatternSizing,speed:2,frame:0,colors:["#e8cce6","#120d22","#442c44","#e6baba","#fff5f5"],stepsPerColor:2,softness:0,scale:.2}},I],Y=(0,t.memo)(function({speed:o=R.params.speed,frame:a=R.params.frame,colors:t=R.params.colors,stepsPerColor:r=R.params.stepsPerColor,softness:l=R.params.softness,fit:n=R.params.fit,scale:f=R.params.scale,rotation:c=R.params.rotation,originX:m=R.params.originX,originY:p=R.params.originY,offsetX:d=R.params.offsetX,offsetY:g=R.params.offsetY,worldWidth:h=R.params.worldWidth,worldHeight:v=R.params.worldHeight,..._}){let x={u_colors:t.map(s.getShaderColorFromString),u_colorsCount:t.length,u_stepsPerColor:r,u_softness:l,u_fit:i.ShaderFitOptions[n],u_scale:f,u_rotation:c,u_offsetX:d,u_offsetY:g,u_originX:m,u_originY:p,u_worldWidth:h,u_worldHeight:v};return(0,u.jsx)(e.ShaderMount,{..._,speed:o,frame:a,fragmentShader:M,uniforms:x})},r.colorPropsAreEqual),A={maxColorCount:8,maxBallsCount:20},X=`#version 300 es
precision mediump float;
...
`,D={name:"Default",params:{...i.defaultObjectSizing,scale:1,speed:1,frame:0,colorBack:"#000000",colors:["#6e33cc","#ff5500","#ffc105","#ffc800","#f585ff"],count:10,size:.83}},j={name:"Ink Drops",params:{...i.defaultObjectSizing,scale:1,speed:2,frame:0,colorBack:"#ffffff00",colors:["#000000"],count:18,size:.1}},N={name:"Background",params:{...i.defaultObjectSizing,speed:.5,frame:0,colors:["#ae00ff","#00ff95","#ffc105"],colorBack:"#2a273f",count:13,size:.81,scale:4,rotation:0,offsetX:-.3}},T=[D,j,{name:"Solar",params:{...i.defaultObjectSizing,speed:1,frame:0,colors:["#ffc800","#ff5500","#ffc105"],colorBack:"#102f84",count:7,size:.75,scale:1}},N],W=(0,t.memo)(function({speed:o=D.params.speed,frame:a=D.params.frame,colorBack:t=D.params.colorBack,colors:r=D.params.colors,size:n=D.params.size,count:f=D.params.count,fit:c=D.params.fit,rotation:m=D.params.rotation,scale:p=D.params.scale,originX:d=D.params.originX,originY:g=D.params.originY,offsetX:h=D.params.offsetX,offsetY:v=D.params.offsetY,worldWidth:_=D.params.worldWidth,worldHeight:x=D.params.worldHeight,...y}){let b={u_colorBack:(0,s.getShaderColorFromString)(t),u_colors:r.map(s.getShaderColorFromString),u_colorsCount:r.length,u_size:n,u_count:f,u_noiseTexture:(0,l.getShaderNoiseTexture)(),u_fit:i.ShaderFitOptions[c],u_rotation:m,u_scale:p,u_offsetX:h,u_offsetY:v,u_originX:d,u_originY:g,u_worldWidth:_,u_worldHeight:x};return(0,u.jsx)(e.ShaderMount,{...y,speed:o,frame:a,fragmentShader:X,uniforms:b})},r.colorPropsAreEqual),G=`#version 300 es
precision mediump float;
...
`,op={name:"Default",params:{...i.defaultObjectSizing,offsetX:0,offsetY:-.55,colorBack:"#000000",colorBloom:"#0000ff",colors:["#a600ff6e","#6200fff0","#ffffff","#33fff5"],density:.3,spotty:.3,midIntensity:.4,midSize:.2,intensity:.8,bloom:.4,speed:.75,frame:0}},od=[op,{name:"Warp",params:{...i.defaultObjectSizing,colorBack:"#000000",colorBloom:"#222288",colors:["#ff47d4","#ff8c00","#ffffff"],density:.45,spotty:.15,midIntensity:.4,midSize:.33,intensity:.79,bloom:.4,speed:2,frame:0}},{name:"Linear",params:{...i.defaultObjectSizing,offsetX:.2,offsetY:-.8,colorBack:"#000000",colorBloom:"#eeeeee",colors:["#ffffff1f","#ffffff3d","#ffffff29"],density:.41,spotty:.25,midSize:.1,midIntensity:.75,intensity:.79,bloom:1,speed:.5,frame:0}},{name:"Ether",params:{...i.defaultObjectSizing,offsetX:-.6,colorBack:"#090f1d",colorBloom:"#ffffff",colors:["#148effa6","#c4dffebe","#232a47"],density:.03,spotty:.77,midSize:.1,midIntensity:.6,intensity:.6,bloom:.6,speed:1,frame:0}}],og=(0,t.memo)(function({speed:o=op.params.speed,frame:a=op.params.frame,colorBloom:t=op.params.colorBloom,colorBack:r=op.params.colorBack,colors:n=op.params.colors,density:f=op.params.density,spotty:c=op.params.spotty,midIntensity:m=op.params.midIntensity,midSize:p=op.params.midSize,intensity:d=op.params.intensity,bloom:g=op.params.bloom,fit:h=op.params.fit,scale:v=op.params.scale,rotation:_=op.params.rotation,originX:x=op.params.originX,originY:y=op.params.originY,offsetX:b=op.params.offsetX,offsetY:S=op.params.offsetY,worldWidth:C=op.params.worldWidth,worldHeight:w=op.params.worldHeight,...k}){let z={u_colorBloom:(0,s.getShaderColorFromString)(t),u_colorBack:(0,s.getShaderColorFromString)(r),u_colors:n.map(s.getShaderColorFromString),u_colorsCount:n.length,u_density:f,u_spotty:c,u_midIntensity:m,u_midSize:p,u_intensity:d,u_bloom:g,u_noiseTexture:(0,l.getShaderNoiseTexture)(),u_fit:i.ShaderFitOptions[h],u_scale:v,u_rotation:_,u_offsetX:b,u_offsetY:S,u_originX:x,u_originY:y,u_worldWidth:C,u_worldHeight:w};return(0,u.jsx)(e.ShaderMount,{...k,speed:o,frame:a,fragmentShader:om,uniforms:z})},r.colorPropsAreEqual),oh=`#version 300 es
precision mediump float;
...
`,ov={name:"Default",params:{...i.defaultPatternSizing,scale:1,colorBack:"#001429",colorFront:"#79D1FF",density:1,distortion:0,strokeWidth:.5,strokeTaper:0,strokeCap:0,noise:0,noiseFrequency:0,softness:0,speed:1,frame:0}},o_={name:"Droplet",params:{...i.defaultPatternSizing,colorBack:"#effafe",colorFront:"#bf40a0",density:.9,distortion:0,strokeWidth:.75,strokeTaper:.18,strokeCap:1,noise:.74,noiseFrequency:.33,softness:.02,speed:1,frame:0}},ox=[ov,{name:"Jungle",params:{...i.defaultPatternSizing,scale:1.3,density:.5,colorBack:"#a0ef2a",colorFront:"#288b18",distortion:0,strokeWidth:.5,strokeTaper:0,strokeCap:0,noise:1,noiseFrequency:.25,softness:0,speed:.75,frame:0}},o_,{name:"Swirl",params:{...i.defaultPatternSizing,scale:.45,colorBack:"#b3e6d9",colorFront:"#1a2b4d",density:.2,distortion:0,strokeWidth:.5,strokeTaper:0,strokeCap:0,noise:0,noiseFrequency:.3,softness:.5,speed:1,frame:0}}],oy=(0,t.memo)(function({speed:o=ov.params.speed,frame:a=ov.params.frame,colorBack:t=ov.params.colorBack,colorFront:r=ov.params.colorFront,density:l=ov.params.density,distortion:n=ov.params.distortion,strokeWidth:f=ov.params.strokeWidth,strokeTaper:c=ov.params.strokeTaper,strokeCap:m=ov.params.strokeCap,noiseFrequency:p=ov.params.noiseFrequency,noise:d=ov.params.noise,softness:g=ov.params.softness,fit:h=ov.params.fit,rotation:v=ov.params.rotation,scale:_=ov.params.scale,originX:x=ov.params.originX,originY:y=ov.params.originY,offsetX:b=ov.params.offsetX,offsetY:S=ov.params.offsetY,worldWidth:C=ov.params.worldWidth,worldHeight:w=ov.params.worldHeight,...k}){let z={u_colorBack:(0,s.getShaderColorFromString)(t),u_colorFront:(0,s.getShaderColorFromString)(r),u_density:l,u_distortion:n,u_strokeWidth:f,u_strokeTaper:c,u_strokeCap:m,u_noiseFrequency:p,u_noise:d,u_softness:g,u_fit:i.ShaderFitOptions[h],u_scale:_,u_rotation:v,u_offsetX:b,u_offsetY:S,u_originX:x,u_originY:y,u_worldWidth:C,u_worldHeight:w};return(0,u.jsx)(e.ShaderMount,{...k,speed:o,frame:a,fragmentShader:oh,uniforms:z})},r.colorPropsAreEqual),ob={maxColorCount:10},oS=`#version 300 es
precision mediump float;
...
`,oC={name:"Default",params:{...i.defaultObjectSizing,speed:.32,frame:0,colorBack:"#330000",colors:["#ffd1d1","#ff8a8a","#660000"],bandCount:4,twist:.1,center:.2,proportion:.5,softness:0,noiseFrequency:.4,noise:.2}},ow={name:"Opening",params:{...i.defaultObjectSizing,offsetX:-.4,offsetY:1,speed:.5,frame:0,colorBack:"#ff8b61",colors:["#fefff0","#ffd8bd","#ff8b61"],bandCount:2,twist:.3,center:.2,proportion:.5,softness:0,noiseFrequency:0,noise:0,scale:1}},ok=[oC,{name:"007",params:{...i.defaultObjectSizing,speed:1,frame:0,colorBack:"#E9E7DA",colors:["#000000"],bandCount:5,twist:.3,center:0,proportion:0,softness:0,noiseFrequency:.5,noise:0}},ow,{name:"Candy",params:{...i.defaultObjectSizing,speed:1,frame:0,colorBack:"#ffcd66",colors:["#6bbceb","#d7b3ff","#ff9fff"],bandCount:2,twist:.15,center:.2,proportion:.5,softness:1,noiseFrequency:.5,noise:0}}],oz=(0,t.memo)(function({speed:o=oC.params.speed,frame:a=oC.params.frame,colorBack:t=oC.params.colorBack,colors:r=oC.params.colors,bandCount:l=oC.params.bandCount,twist:n=oC.params.twist,center:f=oC.params.center,proportion:c=oC.params.proportion,softness:m=oC.params.softness,noiseFrequency:p=oC.params.noiseFrequency,noise:d=oC.params.noise,fit:g=oC.params.fit,rotation:h=oC.params.rotation,scale:v=oC.params.scale,originX:_=oC.params.originX,originY:x=oC.params.originY,offsetX:y=oC.params.offsetX,offsetY:b=oC.params.offsetY,worldWidth:S=oC.params.worldWidth,worldHeight:C=oC.params.worldHeight,...w}){let k={u_colorBack:(0,s.getShaderColorFromString)(t),u_colors:r.map(s.getShaderColorFromString),u_colorsCount:r.length,u_bandCount:l,u_twist:n,u_center:f,u_proportion:c,u_softness:m,u_noiseFrequency:p,u_noise:d,u_fit:i.ShaderFitOptions[g],u_scale:v,u_rotation:h,u_offsetX:y,u_offsetY:b,u_originX:_,u_originY:x,u_worldWidth:S,u_worldHeight:C};return(0,u.jsx)(e.ShaderMount,{...w,speed:o,frame:a,fragmentShader:oS,uniforms:k})},r.colorPropsAreEqual),oB=`#version 300 es
precision mediump float;
...
`,oU={simplex:1,warp:2,dots:3,wave:4,ripple:5,swirl:6,sphere:7},oV={random:1,"2x2":2,"4x4":3,"8x8":4},oO={name:"Default",params:{...i.defaultPatternSizing,speed:1,frame:0,scale:.6,colorBack:"#000000",colorFront:"#00b2ff",shape:"sphere",type:"4x4",size:2}},oF={name:"Sine Wave",params:{...i.defaultPatternSizing,speed:1,frame:0,colorBack:"#730d54",colorFront:"#00becc",shape:"wave",type:"4x4",size:11,scale:1.2}},oM={name:"Bugs",params:{...i.defaultPatternSizing,speed:1,frame:0,colorBack:"#000000",colorFront:"#008000",shape:"dots",type:"random",size:9}},oR={name:"Ripple",params:{...i.defaultObjectSizing,speed:1,frame:0,colorBack:"#603520",colorFront:"#c67953",shape:"ripple",type:"2x2",size:3}},oI={name:"Swirl",params:{...i.defaultObjectSizing,speed:1,frame:0,colorBack:"#00000000",colorFront:"#47a8e1",shape:"swirl",type:"8x8",size:2}},oP=[oO,{name:"Warp",params:{...i.defaultObjectSizing,speed:1,frame:0,colorBack:"#301c2a",colorFront:"#56ae6c",shape:"warp",type:"4x4",size:2.5}},oF,oR,oM,oI],oY=(0,t.memo)(function({speed:o=oO.params.speed,frame:a=oO.params.frame,colorBack:t=oO.params.colorBack,colorFront:r=oO.params.colorFront,shape:l=oO.params.shape,type:n=oO.params.type,pxSize:f,size:c=void 0===f?oO.params.size:f,fit:m=oO.params.fit,scale:p=oO.params.scale,rotation:d=oO.params.rotation,originX:g=oO.params.originX,originY:h=oO.params.originY,offsetX:v=oO.params.offsetX,offsetY:_=oO.params.offsetY,worldWidth:x=oO.params.worldWidth,worldHeight:y=oO.params.worldHeight,...b}){let S={u_colorBack:(0,s.getShaderColorFromString)(t),u_colorFront:(0,s.getShaderColorFromString)(r),u_shape:oU[l],u_type:oV[n],u_pxSize:c,u_fit:i.ShaderFitOptions[m],u_scale:p,u_rotation:d,u_offsetX:v,u_offsetY:_,u_originX:g,u_originY:h,u_worldWidth:x,u_worldHeight:y};return(0,u.jsx)(e.ShaderMount,{...b,speed:o,frame:a,fragmentShader:oB,uniforms:S})});var oA=o.i(82737);let oX={maxColorCount:5,maxSpots:4},oD=`#version 300 es
...
void main() {
  ...
  fragColor = vec4(color, opacity);
}`,oj={auto:0,square:1},oN={name:"Default",params:{...i.defaultObjectSizing,speed:1,frame:0,scale:.6,colorBack:"#000000",colors:["#0dc1fd","#d915ef","#ff3f2ecc"],roundness:.25,thickness:.1,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,aspectRatio:"auto",softness:.75,intensity:.2,bloom:.25,spots:5,spotSize:.5,pulse:.25,smoke:.3,smokeSize:.6}},oT=[oN,{name:"Circle",params:{...i.defaultObjectSizing,aspectRatio:"square",scale:.6,speed:1,frame:0,colorBack:"#000000",colors:["#0dc1fd","#d915ef","#ff3f2ecc"],roundness:1,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,thickness:0,softness:.75,intensity:.2,bloom:.45,spots:3,spotSize:.4,pulse:.5,smoke:1,smokeSize:0}},{name:"Northern lights",params:{...i.defaultObjectSizing,speed:.18,scale:1.1,frame:0,colors:["#4c4794","#774a7d","#12694a","#0aff78","#4733cc"],colorBack:"#0c182c",roundness:0,thickness:1,softness:1,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,aspectRatio:"auto",intensity:.1,bloom:.2,spots:4,spotSize:.25,pulse:0,smoke:.32,smokeSize:.5}},{name:"Solid line",params:{...i.defaultObjectSizing,speed:1,frame:0,colors:["#81ADEC"],colorBack:"#00000000",roundness:0,thickness:.05,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,aspectRatio:"auto",softness:0,intensity:0,bloom:.15,spots:4,spotSize:1,pulse:0,smoke:0,smokeSize:0}}],oW=(0,t.memo)(function({speed:o=oN.params.speed,frame:a=oN.params.frame,colors:t=oN.params.colors,colorBack:r=oN.params.colorBack,roundness:n=oN.params.roundness,thickness:f=oN.params.thickness,aspectRatio:c=oN.params.aspectRatio,softness:m=oN.params.softness,bloom:p=oN.params.bloom,intensity:d=oN.params.intensity,spots:g=oN.params.spots,spotSize:h=oN.params.spotSize,pulse:v=oN.params.pulse,smoke:_=oN.params.smoke,smokeSize:x=oN.params.smokeSize,margin:y,marginLeft:b=y??oN.params.marginLeft,marginRight:S=y??oN.params.marginRight,marginTop:C=y??oN.params.marginTop,marginBottom:w=y??oN.params.marginBottom,fit:k=oN.params.fit,rotation:z=oN.params.rotation,scale:B=oN.params.scale,originX:U=oN.params.originX,originY:V=oN.params.originY,offsetX:O=oN.params.offsetX,offsetY:F=oN.params.offsetY,worldWidth:M=oN.params.worldWidth,worldHeight:R=oN.params.worldHeight,...I}){let P={u_colorBack:(0,s.getShaderColorFromString)(r),u_colors:t.map(s.getShaderColorFromString),u_colorsCount:t.length,u_roundness:n,u_thickness:f,u_marginLeft:b,u_marginRight:S,u_marginTop:C,u_marginBottom:w,u_aspectRatio:oj[c],u_softness:m,u_intensity:d,u_bloom:p,u_spots:g,u_spotSize:h,u_pulse:v,u_smoke:_,u_smokeSize:x,u_noiseTexture:(0,l.getShaderNoiseTexture)(),u_fit:i.ShaderFitOptions[k],u_rotation:z,u_scale:B,u_offsetX:O,u_offsetY:F,u_originX:U,u_originY:V,u_worldWidth:M,u_worldHeight:R};return(0,u.jsx)(e.ShaderMount,{...I,speed:o,frame:a,fragmentShader:oD,uniforms:P})},r.colorPropsAreEqual),oG={maxColorCount:7},oq=`#version 300 es
precision lowp float;
...
void main() {
  ...
  vec4 premultipliedColors[${oG.maxColorCount}];
  for (int i = 0; i < ${oG.maxColorCount}; i++) {
...
`,oH={name:"Default",params:{...i.defaultObjectSizing,speed:.5,frame:0,colors:["#ff9d00","#fd4f30","#809bff","#6d2eff","#333aff","#f15cff","#ffd557"],colorBack:"#000000",angle1:0,angle2:0,length:1.1,edges:!1,blur:0,fadeIn:1,fadeOut:.3,gradient:0,density:3,scale:.8}},o$=[oH,{name:"Glass",params:{...i.defaultObjectSizing,rotation:112,speed:1,frame:0,colors:["#00cfff","#ff2d55","#34c759","#af52de"],colorBack:"#ffffff00",angle1:.3,angle2:.3,length:1,edges:!0,blur:.25,fadeIn:.85,fadeOut:.3,gradient:0,density:1.6}},{name:"Gradient",params:{...i.defaultObjectSizing,speed:.5,frame:0,colors:["#f2ff00","#00000000","#00000000","#5a0283","#005eff"],colorBack:"#8ffff2",angle1:.4,angle2:.4,length:3,edges:!1,blur:.5,fadeIn:1,fadeOut:.39,gradient:.78,density:1.65,scale:1.72,rotation:270,offsetX:.18}},{name:"Opening",params:{...i.defaultObjectSizing,speed:2,frame:0,colors:["#00ffff"],colorBack:"#570044",angle1:-1,angle2:-1,length:.52,edges:!1,blur:0,fadeIn:0,fadeOut:1,gradient:0,density:2.21,scale:2.32,rotation:360,offsetX:-.3,offsetY:.6}}],oL=(0,t.memo)(function({speed:o=oH.params.speed,frame:a=oH.params.frame,colors:t=oH.params.colors,colorBack:r=oH.params.colorBack,angle1:l=oH.params.angle1,angle2:n=oH.params.angle2,length:f=oH.params.length,edges:c=oH.params.edges,blur:m=oH.params.blur,fadeIn:p=oH.params.fadeIn,fadeOut:d=oH.params.fadeOut,density:g=oH.params.density,gradient:h=oH.params.gradient,fit:v=oH.params.fit,scale:_=oH.params.scale,rotation:x=oH.params.rotation,originX:y=oH.params.originX,originY:b=oH.params.originY,offsetX:S=oH.params.offsetX,offsetY:C=oH.params.offsetY,worldWidth:w=oH.params.worldWidth,worldHeight:k=oH.params.worldHeight,...z}){let B={u_colors:t.map(s.getShaderColorFromString),u_colorsCount:t.length,u_colorBack:(0,s.getShaderColorFromString)(r),u_angle1:l,u_angle2:n,u_length:f,u_edges:c,u_blur:m,u_fadeIn:p,u_fadeOut:d,u_density:g,u_gradient:h,u_fit:i.ShaderFitOptions[v],u_scale:_,u_rotation:x,u_offsetX:S,u_offsetY:C,u_originX:y,u_originY:b,u_worldWidth:w,u_worldHeight:k};return(0,u.jsx)(e.ShaderMount,{...z,speed:o,frame:a,fragmentShader:oq,uniforms:B})},r.colorPropsAreEqual),oE={maxColorCount:10},oK=`#version 300 es
precision mediump float;
...
void main() {
  ...
  for (int i = 0; i < ${oE.maxColorCount}; i++) {
    if (i >= int(u_colorsCount)) break;
...
`,oJ={name:"Default",params:{...i.defaultObjectSizing,rotation:270,speed:0,frame:0,colors:["#ffad0a","#6200ff","#e2a3ff","#ff99fd"],positions:2,waveX:1,waveXShift:.6,waveY:1,waveYShift:.21,mixing:.93,grainMixer:0,grainOverlay:0}},oQ={name:"Sea",params:{...i.defaultObjectSizing,speed:0,frame:0,colors:["#013b65","#03738c","#a3d3ff","#f2faef"],positions:0,waveX:.53,waveXShift:0,waveY:.95,waveYShift:.64,mixing:.5,grainMixer:0,grainOverlay:0}},oZ=[oJ,{name:"1960s",params:{...i.defaultObjectSizing,speed:0,frame:0,colors:["#000000","#082400","#b1aa91","#8e8c15"],positions:42,waveX:.45,waveXShift:0,waveY:1,waveYShift:0,mixing:0,grainMixer:.37,grainOverlay:.78}},{name:"Sunset",params:{...i.defaultObjectSizing,speed:0,frame:0,colors:["#264653","#9c2b2b","#f4a261","#ffffff"],positions:0,waveX:.6,waveXShift:.7,waveY:.7,waveYShift:.7,mixing:.5,grainMixer:0,grainOverlay:0}},oQ],o0=(0,t.memo)(function({speed:o=oJ.params.speed,frame:a=oJ.params.frame,colors:t=oJ.params.colors,positions:r=oJ.params.positions,waveX:l=oJ.params.waveX,waveXShift:n=oJ.params.waveXShift,waveY:f=oJ.params.waveY,waveYShift:c=oJ.params.waveYShift,mixing:m=oJ.params.mixing,grainMixer:p=oJ.params.grainMixer,grainOverlay:d=oJ.params.grainOverlay,fit:g=oJ.params.fit,rotation:h=oJ.params.rotation,scale:v=oJ.params.scale,originX:_=oJ.params.originX,originY:x=oJ.params.originY,offsetX:y=oJ.params.offsetX,offsetY:b=oJ.params.offsetY,worldWidth:S=oJ.params.worldWidth,worldHeight:C=oJ.params.worldHeight,...w}){let k={u_colors:t.map(s.getShaderColorFromString),u_colorsCount:t.length,u_positions:r,u_waveX:l,u_waveXShift:n,u_waveY:f,u_waveYShift:c,u_mixing:m,u_grainMixer:p,u_grainOverlay:d,u_fit:i.ShaderFitOptions[g],u_rotation:h,u_scale:v,u_offsetX:y,u_offsetY:b,u_originX:_,u_originY:x,u_worldWidth:S,u_worldHeight:C};return(0,u.jsx)(e.ShaderMount,{...w,speed:o,frame:a,fragmentShader:oK,uniforms:k})},r.colorPropsAreEqual),o1={maxColorCount:10},o2=`#version 300 es
precision mediump float;
...
`,o5={name:"Default",params:{...i.defaultObjectSizing,scale:1,speed:0,frame:0,colorBack:"#000000",colors:["#00bbff","#00ffe1","#ffffff"],radius:.8,focalDistance:.99,focalAngle:0,falloff:.24,mixing:.5,distortion:0,distortionShift:0,distortionFreq:12,grainMixer:0,grainOverlay:0}},o3={name:"Cross Section",params:{...i.defaultObjectSizing,scale:1,speed:0,frame:0,colorBack:"#3d348b",colors:["#7678ed","#f7b801","#f18701","#37a066"],radius:1,focalDistance:0,focalAngle:0,falloff:0,mixing:0,distortion:1,distortionShift:0,distortionFreq:12,grainMixer:0,grainOverlay:0}},o4={name:"Radial",params:{...i.defaultObjectSizing,scale:1,speed:0,frame:0,colorBack:"#264653",colors:["#9c2b2b","#f4a261","#ffffff"],radius:1,focalDistance:0,focalAngle:0,falloff:0,mixing:1,distortion:0,distortionShift:0,distortionFreq:12,grainMixer:0,grainOverlay:0}},o9=[o5,{name:"Lo-Fi",params:{...i.defaultObjectSizing,speed:0,frame:0,colorBack:"#2e1f27",colors:["#d72638","#3f88c5","#f49d37"],radius:1,focalDistance:0,focalAngle:0,falloff:.9,mixing:.7,distortion:0,distortionShift:0,distortionFreq:12,grainMixer:1,grainOverlay:.5}},o3,o4],o8=(0,t.memo)(function({speed:o=o5.params.speed,frame:a=o5.params.frame,colorBack:t=o5.params.colorBack,colors:r=o5.params.colors,radius:l=o5.params.radius,focalDistance:n=o5.params.focalDistance,focalAngle:f=o5.params.focalAngle,falloff:c=o5.params.falloff,grainMixer:m=o5.params.grainMixer,mixing:p=o5.params.mixing,distortion:d=o5.params.distortion,distortionShift:g=o5.params.distortionShift,distortionFreq:h=o5.params.distortionFreq,grainOverlay:v=o5.params.grainOverlay,fit:_=o5.params.fit,rotation:x=o5.params.rotation,scale:y=o5.params.scale,originX:b=o5.params.originX,originY:S=o5.params.originY,offsetX:C=o5.params.offsetX,offsetY:w=o5.params.offsetY,worldWidth:k=o5.params.worldWidth,worldHeight:z=o5.params.worldHeight,...B}){let U={u_colorBack:(0,s.getShaderColorFromString)(t),u_colors:r.map(s.getShaderColorFromString),u_colorsCount:r.length,u_radius:l,u_focalDistance:n,u_focalAngle:f,u_falloff:c,u_mixing:p,u_distortion:d,u_distortionShift:g,u_distortionFreq:h,u_grainMixer:m,u_grainOverlay:v,u_fit:i.ShaderFitOptions[_],u_rotation:x,u_scale:y,u_offsetX:C,u_offsetY:w,u_originX:b,u_originY:S,u_worldWidth:k,u_worldHeight:z};return(0,u.jsx)(e.ShaderMount,{...B,speed:o,frame:a,fragmentShader:o2,uniforms:U})},r.colorPropsAreEqual),o6=`#version 300 es
precision mediump float;
...
`,o7={name:"Default",params:{...i.defaultObjectSizing,fit:"cover",scale:.6,speed:0,frame:0,colorFront:"#9fadbc",colorBack:"#ffffff",contrast:.3,roughness:.4,fiber:.3,fiberSize:.2,crumples:.3,crumpleSize:.35,folds:.65,foldCount:5,fade:0,drops:.2,seed:5.8}},eo={name:"Abstract",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,scale:.6,colorFront:"#00eeff",colorBack:"#ff0a81",contrast:.85,roughness:0,fiber:.1,fiberSize:.2,crumples:0,crumpleSize:.3,folds:1,foldCount:3,fade:0,drops:.2,seed:2.2}},ee=[o7,{name:"Cardboard",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,scale:.6,colorFront:"#c7b89e",colorBack:"#999180",contrast:.4,roughness:0,fiber:.35,fiberSize:.14,crumples:.7,crumpleSize:.1,folds:0,foldCount:1,fade:0,drops:.1,seed:1.6}},eo,{name:"Details",params:{...i.defaultObjectSizing,speed:0,frame:0,fit:"cover",scale:3,colorFront:"#00000000",colorBack:"#00000000",contrast:0,roughness:1,fiber:.27,fiberSize:.22,crumples:1,crumpleSize:.5,folds:1,foldCount:15,fade:0,drops:0,seed:6}}],ea=(0,t.memo)(function({speed:o=o7.params.speed,frame:a=o7.params.frame,colorFront:t=o7.params.colorFront,colorBack:r=o7.params.colorBack,image:n="",contrast:f=o7.params.contrast,roughness:c=o7.params.roughness,fiber:m=o7.params.fiber,crumples:p=o7.params.crumples,folds:d=o7.params.folds,drops:g=o7.params.drops,seed:h=o7.params.seed,fiberScale:v,fiberSize:_=void 0===v?o7.params.fiberSize:.2/v,crumplesScale:x,crumpleSize:y=void 0===x?o7.params.crumpleSize:.2/x,blur:b,fade:S=void 0===b?o7.params.fade:b,foldsNumber:C,foldCount:w=void 0===C?o7.params.foldCount:C,fit:k=o7.params.fit,scale:z=o7.params.scale,rotation:B=o7.params.rotation,originX:U=o7.params.originX,originY:V=o7.params.originY,offsetX:O=o7.params.offsetX,offsetY:F=o7.params.offsetY,worldWidth:M=o7.params.worldWidth,worldHeight:R=o7.params.worldHeight,...I}){let P="u">typeof window&&{u_noiseTexture:(0,l.getShaderNoiseTexture)()},Y={u_image:n,u_colorFront:(0,s.getShaderColorFromString)(t),u_colorBack:(0,s.getShaderColorFromString)(r),u_contrast:f,u_roughness:c,u_fiber:m,u_fiberSize:_,u_crumples:p,u_crumpleSize:y,u_foldCount:w,u_folds:d,u_fade:S,u_drops:g,u_seed:h,...P,u_fit:i.ShaderFitOptions[k],u_scale:z,u_rotation:B,u_offsetX:O,u_offsetY:F,u_originX:U,u_originY:V,u_worldWidth:M,u_worldHeight:R};return(0,u.jsx)(e.ShaderMount,{...I,speed:o,frame:a,fragmentShader:o6,mipmaps:["u_image"],uniforms:Y})},r.colorPropsAreEqual),et=`#version 300 es
precision mediump float;
...
`,er={lines:1,linesIrregular:2,wave:3,zigzag:4,pattern:5},ei={prism:1,lens:2,contour:3,cascade:4,flat:5},es={name:"Default",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,colorBack:"#00000000",colorShadow:"#000000",colorHighlight:"#ffffff",shadows:.25,size:.5,angle:0,distortionShape:"prism",highlights:.1,shape:"lines",distortion:.5,shift:0,blur:0,edges:.25,stretch:0,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,grainMixer:0,grainOverlay:0}},el={name:"Waves",params:{...i.defaultObjectSizing,fit:"cover",scale:1.2,speed:0,frame:0,colorBack:"#00000000",colorShadow:"#000000",colorHighlight:"#ffffff",shadows:0,size:.9,angle:0,distortionShape:"contour",highlights:0,shape:"wave",distortion:.5,shift:0,blur:.1,edges:.5,stretch:1,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,grainMixer:0,grainOverlay:.05}},en=[es,{name:"Abstract",params:{...i.defaultObjectSizing,fit:"cover",scale:4,speed:0,frame:0,colorBack:"#00000000",colorShadow:"#000000",colorHighlight:"#ffffff",shadows:0,size:.7,angle:30,distortionShape:"flat",highlights:0,shape:"linesIrregular",distortion:1,shift:0,blur:1,edges:.5,stretch:1,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,grainMixer:.1,grainOverlay:.1}},el,{name:"Folds",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,colorBack:"#00000000",colorShadow:"#000000",colorHighlight:"#ffffff",shadows:.4,size:.4,angle:0,distortionShape:"cascade",highlights:0,shape:"lines",distortion:.75,shift:0,blur:.25,edges:.5,stretch:0,margin:.1,marginLeft:.1,marginRight:.1,marginTop:.1,marginBottom:.1,grainMixer:0,grainOverlay:0}}],ef=(0,t.memo)(function({speed:o=es.params.speed,frame:a=es.params.frame,colorBack:t=es.params.colorBack,colorShadow:r=es.params.colorShadow,colorHighlight:l=es.params.colorHighlight,image:n="",shadows:f=es.params.shadows,angle:c=es.params.angle,distortion:m=es.params.distortion,distortionShape:p=es.params.distortionShape,highlights:d=es.params.highlights,shape:g=es.params.shape,shift:h=es.params.shift,blur:v=es.params.blur,edges:_=es.params.edges,margin:x,marginLeft:y=x??es.params.marginLeft,marginRight:b=x??es.params.marginRight,marginTop:S=x??es.params.marginTop,marginBottom:C=x??es.params.marginBottom,grainMixer:w=es.params.grainMixer,grainOverlay:k=es.params.grainOverlay,stretch:z=es.params.stretch,count:B,size:U=void 0===B?es.params.size:Math.pow(1/(1.6*B),1/6)/.7-.5,fit:V=es.params.fit,scale:O=es.params.scale,rotation:F=es.params.rotation,originX:M=es.params.originX,originY:R=es.params.originY,offsetX:I=es.params.offsetX,offsetY:P=es.params.offsetY,worldWidth:Y=es.params.worldWidth,worldHeight:A=es.params.worldHeight,...X}){let D={u_image:n,u_colorBack:(0,s.getShaderColorFromString)(t),u_colorShadow:(0,s.getShaderColorFromString)(r),u_colorHighlight:(0,s.getShaderColorFromString)(l),u_shadows:f,u_size:U,u_angle:c,u_distortion:m,u_shift:h,u_blur:v,u_edges:_,u_stretch:z,u_distortionShape:ei[p],u_highlights:d,u_shape:er[g],u_marginLeft:y,u_marginRight:b,u_marginTop:S,u_marginBottom:C,u_grainMixer:w,u_grainOverlay:k,u_fit:i.ShaderFitOptions[V],u_scale:O,u_rotation:F,u_offsetX:I,u_offsetY:P,u_originX:M,u_originY:R,u_worldWidth:Y,u_worldHeight:A};return(0,u.jsx)(e.ShaderMount,{...X,speed:o,frame:a,fragmentShader:et,mipmaps:["u_image"],uniforms:D})}),ec=`#version 300 es
precision mediump float;
...
`,eu={name:"Default",params:{...i.defaultObjectSizing,scale:.8,speed:1,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:.07,layering:.5,edges:.8,waves:.3,caustic:.1,size:1}},em={name:"Abstract",params:{...i.defaultObjectSizing,fit:"cover",scale:3,speed:1,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:0,layering:0,edges:1,waves:1,caustic:.4,size:.15}},ep={name:"Streaming",params:{...i.defaultObjectSizing,fit:"contain",scale:.4,speed:2,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:0,layering:0,edges:0,waves:.5,caustic:0,size:.5}},ed=[eu,{name:"Slow-mo",params:{...i.defaultObjectSizing,fit:"cover",scale:1,speed:.1,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:.4,layering:0,edges:0,waves:0,caustic:.2,size:.7}},em,ep],eg=(0,t.memo)(function({speed:o=eu.params.speed,frame:a=eu.params.frame,colorBack:t=eu.params.colorBack,colorHighlight:r=eu.params.colorHighlight,image:l="",highlights:n=eu.params.highlights,layering:f=eu.params.layering,waves:c=eu.params.waves,edges:m=eu.params.edges,caustic:p=eu.params.caustic,effectScale:d,size:g=void 0===d?eu.params.size:10/9/d-1/9,fit:h=eu.params.fit,scale:v=eu.params.scale,rotation:_=eu.params.rotation,originX:x=eu.params.originX,originY:y=eu.params.originY,offsetX:b=eu.params.offsetX,offsetY:S=eu.params.offsetY,worldWidth:C=eu.params.worldWidth,worldHeight:w=eu.params.worldHeight,...k}){let z={u_image:l,u_colorBack:(0,s.getShaderColorFromString)(t),u_colorHighlight:(0,s.getShaderColorFromString)(r),u_highlights:n,u_layering:f,u_waves:c,u_edges:m,u_caustic:p,u_size:g,u_fit:i.ShaderFitOptions[h],u_rotation:_,u_scale:v,u_offsetX:b,u_offsetY:S,u_originX:x,u_originY:y,u_worldWidth:C,u_worldHeight:w};return(0,u.jsx)(e.ShaderMount,{...k,speed:o,frame:a,fragmentShader:ec,mipmaps:["u_image"],uniforms:z})},r.colorPropsAreEqual),eh=`#version 300 es
precision mediump float;
...
`,ev={name:"Default",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,colorFront:"#94ffaf",colorBack:"#000c38",colorHighlight:"#eaff94",type:"8x8",size:2,colorSteps:2,originalColors:!1,inverted:!1}},e_={name:"Retro",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,colorFront:"#eeeeee",colorBack:"#5452ff",colorHighlight:"#eeeeee",type:"2x2",size:3,colorSteps:1,originalColors:!0,inverted:!1}},ex=[ev,{name:"Noise",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,colorFront:"#a2997c",colorBack:"#000000",colorHighlight:"#ededed",type:"random",size:1,colorSteps:1,originalColors:!1,inverted:!1}},e_,{name:"Natural",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,colorFront:"#ffffff",colorBack:"#000000",colorHighlight:"#ffffff",type:"8x8",size:2,colorSteps:5,originalColors:!0,inverted:!1}}],ey=(0,t.memo)(function({speed:o=ev.params.speed,frame:a=ev.params.frame,colorFront:t=ev.params.colorFront,colorBack:r=ev.params.colorBack,colorHighlight:l=ev.params.colorHighlight,image:n="",type:f=ev.params.type,colorSteps:c=ev.params.colorSteps,originalColors:m=ev.params.originalColors,inverted:p=ev.params.inverted,pxSize:d,size:g=void 0===d?ev.params.size:d,fit:h=ev.params.fit,scale:v=ev.params.scale,rotation:_=ev.params.rotation,originX:x=ev.params.originX,originY:y=ev.params.originY,offsetX:b=ev.params.offsetX,offsetY:S=ev.params.offsetY,worldWidth:C=ev.params.worldWidth,worldHeight:w=ev.params.worldHeight,...k}){let z={u_image:n,u_colorFront:(0,s.getShaderColorFromString)(t),u_colorBack:(0,s.getShaderColorFromString)(r),u_colorHighlight:(0,s.getShaderColorFromString)(l),u_type:oV[f],u_pxSize:g,u_colorSteps:c,u_originalColors:m,u_inverted:p,u_fit:i.ShaderFitOptions[h],u_rotation:_,u_scale:v,u_offsetX:b,u_offsetY:S,u_originX:x,u_originY:y,u_worldWidth:C,u_worldHeight:w};return(0,u.jsx)(e.ShaderMount,{...k,speed:o,frame:a,fragmentShader:eh,uniforms:z})},r.colorPropsAreEqual),eb={maxColorCount:10},eS=`#version 300 es
...
void main() {
  ...
  gradient.rgb *= gradient.a;
  float outerShape = 0.;
  for (int i = 1; i < ${eb.maxColorCount+1}; i++) {
    if (i > int(u_colorsCount)) break;
    float m = clamp(mixer - float(i - 1), 0., 1.);
    if (i == 1) {
      outerShape = m;
...
`;function eC(o){let e=document.createElement("canvas");return new Promise((a,t)=>{let r=new Image;r.crossOrigin="anonymous",r.addEventListener("load",()=>{("string"==typeof o?o.endsWith(".svg"):"image/svg+xml"===o.type)&&(r.width=1e3,r.height=1e3);let i=r.naturalWidth/r.naturalHeight,s=Math.floor(150),l=Math.ceil(2.5*s),n=1e3,f=1e3;i>1?f=Math.floor(1e3/i):n=Math.floor(1e3*i),e.width=n+2*l,e.height=f+2*l;let c=e.getContext("2d",{willReadFrequently:!0});if(!c)throw Error("Failed to get canvas 2d context");c.fillStyle="white",c.fillRect(0,0,e.width,e.height),c.drawImage(r,l,l,n,f);let{width:u,height:m}=e,p=c.getImageData(0,0,u,m).data,d=u*m,g=new Uint8ClampedArray(d);for(let o=0;o<d;o++){let e=4*o,a=p[e]??0,t=p[e+1]??0,r=p[e+2]??0;g[o]=.299*a+.587*t+.114*r|0}let h=Math.max(1,Math.round(.12*s)),v=ek(g,u,m,s,3),_=ek(g,u,m,h,3),x=ek(g,u,m,5,1),y=c.createImageData(u,m),b=y.data;for(let o=0;o<d;o++){let e=4*o;b[e]=x[o]??0,b[e+1]=v[o]??0,b[e+2]=_[o]??0,b[e+3]=255}c.putImageData(y,0,0),e.toBlob(o=>{o?a({blob:o}):t(Error("Failed to create PNG blob"))},"image/png")}),r.addEventListener("error",()=>{t(Error("Failed to load image"))}),r.src="string"==typeof o?o:URL.createObjectURL(o)})}function ew(o,e,a,t){if(t<=0)return o.slice();let r=new Uint8ClampedArray(e*a),i=new Uint32Array(e*a);for(let t=0;t<a;t++){let a=0;for(let r=0;r<e;r++){let s=t*e+r;a+=o[s]??0,i[s]=a+(t>0?i[s-e]??0:0)}}for(let o=0;o<a;o++){let s=Math.max(0,o-t),l=Math.min(a-1,o+t);for(let a=0;a<e;a++){let n=Math.max(0,a-t),f=Math.min(e-1,a+t),c=l*e+f,u=l*e+(n-1),m=(s-1)*e+f,p=(s-1)*e+(n-1),d=(i[c]??0)-(n>0?i[u]??0:0)-(s>0?i[m]??0:0)+(n>0&&s>0?i[p]??0:0),g=(f-n+1)*(l-s+1);r[o*e+a]=Math.round(d/g)}}return r}function ek(o,e,a,t,r){if(t<=0||r<=1)return ew(o,e,a,t);let i=o,s=o;for(let o=0;o<r;o++)i=s=ew(i,e,a,t);return s}let ez="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",eB=[],eU=(o,e)=>(function(o,e=null){for(let a of(null===e&&(e=[o]),eB))if(function(o,e){if(o===e)return!0;if(!o||!e)return!1;let a=o.length;if(e.length!==a)return!1;for(let t=0;t<a;t++)if(o[t]!==e[t])return!1;return!0}(e,a.keys)){if(Object.prototype.hasOwnProperty.call(a,"error"))throw a.error;if(Object.prototype.hasOwnProperty.call(a,"response"))return a.response;throw a.promise}let a={keys:e,promise:("object"==typeof o&&"function"==typeof o.then?o:o(...e)).then(o=>{a.response=o}).catch(o=>a.error=o)};throw eB.push(a),a.promise})(o,e),eV={name:"Default",params:{...i.defaultObjectSizing,scale:.75,speed:1,frame:0,contour:.5,angle:0,noise:0,innerGlow:.5,outerGlow:.5,colorBack:"#000000",colors:["#11206a","#1f3ba2","#2f63e7","#6bd7ff","#ffe679","#ff991e","#ff4c00"]}},eO=[eV,{name:"Sepia",params:{...i.defaultObjectSizing,scale:.75,speed:.5,frame:0,contour:.5,angle:0,noise:.75,innerGlow:.5,outerGlow:.5,colorBack:"#000000",colors:["#997F45","#ffffff"]}}],eF=(0,t.memo)(function({speed:o=eV.params.speed,frame:a=eV.params.frame,image:r="",contour:l=eV.params.contour,angle:n=eV.params.angle,noise:f=eV.params.noise,innerGlow:c=eV.params.innerGlow,outerGlow:m=eV.params.outerGlow,colorBack:p=eV.params.colorBack,colors:d=eV.params.colors,suspendWhenProcessingImage:g=!1,fit:h=eV.params.fit,offsetX:v=eV.params.offsetX,offsetY:_=eV.params.offsetY,originX:x=eV.params.originX,originY:y=eV.params.originY,rotation:b=eV.params.rotation,scale:S=eV.params.scale,worldHeight:C=eV.params.worldHeight,worldWidth:w=eV.params.worldWidth,...k}){let z,B="string"==typeof r?r:r.src,[U,V]=(0,t.useState)(ez);z=g&&"u">typeof window?eU(()=>eC(B).then(o=>URL.createObjectURL(o.blob)),[B,"heatmap"]):U,(0,t.useLayoutEffect)(()=>{if(g)return;if(!B)return void V(ez);let o=!0;return eC(B).then(e=>{o&&V(URL.createObjectURL(e.blob))}),()=>{o=!1}},[B,g]);let O=(0,t.useMemo)(()=>({u_image:z,u_contour:l,u_angle:n,u_noise:f,u_innerGlow:c,u_outerGlow:m,u_colorBack:(0,s.getShaderColorFromString)(p),u_colors:d.map(s.getShaderColorFromString),u_colorsCount:d.length,u_fit:i.ShaderFitOptions[h],u_offsetX:v,u_offsetY:_,u_originX:x,u_originY:y,u_rotation:b,u_scale:S,u_worldHeight:C,u_worldWidth:w}),[o,a,l,n,f,c,m,d,p,z,h,v,_,x,y,b,S,C,w]);return(0,u.jsx)(e.ShaderMount,{...k,speed:o,frame:a,fragmentShader:eS,mipmaps:["u_image"],uniforms:O})},r.colorPropsAreEqual),eM=`#version 300 es
precision mediump float;
...
`;function eR(o){let e=document.createElement("canvas"),a=e.getContext("2d"),t="string"==typeof o&&o.startsWith("blob:");return new Promise((r,i)=>{if(!o||!a)return void i(Error("Invalid file or canvas context"));let s=t&&fetch(o).then(o=>o.headers.get("Content-Type")),l=new Image;l.crossOrigin="anonymous";let n=performance.now();l.onload=async()=>{let t,n=await s;t=n?"image/svg+xml"===n:"string"==typeof o?o.endsWith(".svg")||o.startsWith("data:image/svg+xml"):"image/svg+xml"===o.type;let f=l.width||l.naturalWidth,c=l.height||l.naturalHeight;if(t){let o=f/c;f>c?(f=4096,c=4096/o):(c=4096,f=4096*o),l.width=f,l.height=c}let u=512/Math.min(f,c),m=Math.round(f*u),p=Math.round(c*u);e.width=f,e.height=c;let d=document.createElement("canvas");d.width=m,d.height=p;let g=d.getContext("2d");g.drawImage(l,0,0,m,p);let h=performance.now(),v=g.getImageData(0,0,m,p).data,_=new Uint8Array(m*p),x=new Uint8Array(m*p),y=0;for(let o=0,e=0;o<v.length;o+=4,e++){let a=+(0!==v[o+3]);_[e]=a,y+=a}let b=[],S=[];for(let o=0;o<p;o++)for(let e=0;e<m;e++){let a=o*m+e;if(_[a])0!==e&&e!==m-1&&0!==o&&o!==p-1&&_[a-1]&&_[a+1]&&_[a-m]&&_[a+m]&&_[a-m-1]&&_[a-m+1]&&_[a+m-1]&&_[a+m+1]?S.push(a):(x[a]=1,b.push(a))}let C=function(o,e,a,t,r){let i=e.length,s=new Int32Array(4*i);for(let a=0;a<i;a++){let i=e[a],l=i%t,n=Math.floor(i/t);s[4*a+0]=l<t-1&&o[i+1]?i+1:-1,s[4*a+1]=l>0&&o[i-1]?i-1:-1,s[4*a+2]=n>0&&o[i-t]?i-t:-1,s[4*a+3]=n<r-1&&o[i+t]?i+t:-1}return{interiorPixels:e,boundaryPixels:a,pixelCount:i,neighborIndices:s}}(_,new Uint32Array(S),new Uint32Array(b),m,p),w=performance.now(),k=function(o,e,a){let t=new Float32Array(e*a),{interiorPixels:r,neighborIndices:i,pixelCount:s}=o,l=performance.now(),n=[],f=[];for(let o=0;o<s;o++){let a=r[o];(a%e+Math.floor(a/e))%2==0?n.push(o):f.push(o)}for(let o=0;o<40;o++){for(let o of n){let e=r[o],a=i[4*o+0],s=i[4*o+1],l=i[4*o+2],n=i[4*o+3],f=0;a>=0&&(f+=t[a]),s>=0&&(f+=t[s]),l>=0&&(f+=t[l]),n>=0&&(f+=t[n]);let c=(.01+f)/4;t[e]=1.9*c+-.8999999999999999*t[e]}for(let o of f){let e=r[o],a=i[4*o+0],s=i[4*o+1],l=i[4*o+2],n=i[4*o+3],f=0;a>=0&&(f+=t[a]),s>=0&&(f+=t[s]),l>=0&&(f+=t[l]),n>=0&&(f+=t[n]);let c=(.01+f)/4;t[e]=1.9*c+-.8999999999999999*t[e]}}0;return t}(C,m,p);let z=0;for(let o=0;o<S.length;o++){let e=S[o];k[e]>z&&(z=k[e])}let B=document.createElement("canvas");B.width=m,B.height=p;let U=B.getContext("2d"),V=U.createImageData(m,p);for(let o=0;o<p;o++)for(let e=0;e<m;e++){let a=o*m+e,t=4*a;if(_[a]){let o=255*(1-k[a]/z);V.data[t]=o,V.data[t+1]=o,V.data[t+2]=o,V.data[t+3]=255}else V.data[t]=255,V.data[t+1]=255,V.data[t+2]=255,V.data[t+3]=0}U.putImageData(V,0,0),a.imageSmoothingEnabled=!0,a.imageSmoothingQuality="high",a.drawImage(B,0,0,m,p,0,0,f,c);let O=a.getImageData(0,0,f,c),F=document.createElement("canvas");F.width=f,F.height=c;let M=F.getContext("2d");M.drawImage(l,0,0,f,c);let R=M.getImageData(0,0,f,c);for(let o=0;o<O.data.length;o+=4){let e=R.data[o+3],a=O.data[o+3];0===e?(O.data[o]=255,O.data[o+1]=0):(O.data[o]=0===a?0:O.data[o],O.data[o+1]=e),O.data[o+2]=255,O.data[o+3]=255}a.putImageData(O,0,0),e.toBlob(o=>{if(!o)return void i(Error("Failed to create PNG blob"));0;r({imageData:O,pngBlob:o})},"image/png")},l.onerror=()=>i(Error("Failed to load image")),l.src="string"==typeof o?o:URL.createObjectURL(o)})}let eI={none:0,circle:1,daisy:2,diamond:3,metaballs:4},eP={name:"Default",params:{...i.defaultObjectSizing,scale:.6,speed:1,frame:0,colorBack:"#AAAAAC",colorTint:"#ffffff",distortion:.07,repetition:2,shiftRed:.3,shiftBlue:.3,contour:.4,softness:.1,angle:70,shape:"diamond"}},eY=[eP,{name:"Noir",params:{...i.defaultObjectSizing,scale:.6,speed:1,frame:0,colorBack:"#000000",colorTint:"#606060",softness:.45,repetition:1.5,shiftRed:0,shiftBlue:0,distortion:0,contour:0,angle:90,shape:"diamond"}},{name:"Backdrop",params:{...i.defaultObjectSizing,speed:1,frame:0,scale:1,colorBack:"#AAAAAC",colorTint:"#ffffff",softness:.05,repetition:1.5,shiftRed:.3,shiftBlue:.3,distortion:.1,contour:.4,shape:"none",angle:90,worldWidth:0,worldHeight:0}},{name:"Stripes",params:{...i.defaultObjectSizing,speed:1,frame:0,scale:.6,colorBack:"#000000",colorTint:"#2c5d72",softness:.8,repetition:6,shiftRed:1,shiftBlue:-1,distortion:.4,contour:.4,shape:"circle",angle:0}}],eA=(0,t.memo)(function({colorBack:o=eP.params.colorBack,colorTint:a=eP.params.colorTint,speed:r=eP.params.speed,frame:l=eP.params.frame,image:n="",contour:f=eP.params.contour,distortion:c=eP.params.distortion,softness:m=eP.params.softness,repetition:p=eP.params.repetition,shiftRed:d=eP.params.shiftRed,shiftBlue:g=eP.params.shiftBlue,angle:h=eP.params.angle,shape:v=eP.params.shape,suspendWhenProcessingImage:_=!1,fit:x=eP.params.fit,scale:y=eP.params.scale,rotation:b=eP.params.rotation,originX:S=eP.params.originX,originY:C=eP.params.originY,offsetX:w=eP.params.offsetX,offsetY:k=eP.params.offsetY,worldWidth:z=eP.params.worldWidth,worldHeight:B=eP.params.worldHeight,...U}){let V,O="string"==typeof n?n:n.src,[F,M]=(0,t.useState)(ez);V=_&&"u">typeof window&&O?eU(()=>eR(O).then(o=>URL.createObjectURL(o.pngBlob)),[O,"liquid-metal"]):F,(0,t.useLayoutEffect)(()=>{if(_)return;if(!O)return void M(ez);let o=!0;return eR(O).then(e=>{o&&M(URL.createObjectURL(e.pngBlob))}),()=>{o=!1}},[O,_]);let R={u_colorBack:(0,s.getShaderColorFromString)(o),u_colorTint:(0,s.getShaderColorFromString)(a),u_image:V,u_contour:f,u_distortion:c,u_softness:m,u_repetition:p,u_shiftRed:d,u_shiftBlue:g,u_angle:h,u_isImage:!!n,u_shape:eI[v],u_fit:i.ShaderFitOptions[x],u_scale:y,u_rotation:b,u_offsetX:w,u_offsetY:k,u_originX:S,u_originY:C,u_worldWidth:z,u_worldHeight:B};return(0,u.jsx)(e.ShaderMount,{...U,speed:r,frame:l,fragmentShader:eM,mipmaps:["u_image"],uniforms:R})}),eX=`#version 300 es
precision mediump float;
...
`,eD={classic:0,gooey:1,holes:2,soft:3},ej={square:0,hex:1},eN={name:"Default",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,colorBack:"#f2f1e8",colorFront:"#2b2b2b",size:.5,radius:1.25,contrast:.4,originalColors:!1,inverted:!1,grainMixer:.2,grainOverlay:.2,grainSize:.5,grid:"hex",type:"gooey"}},eT=[eN,{name:"LED screen",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,colorBack:"#000000",colorFront:"#29ff7b",size:.5,radius:1.5,contrast:.3,originalColors:!1,inverted:!1,grainMixer:0,grainOverlay:0,grainSize:.5,grid:"square",type:"soft"}},{name:"Mosaic",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,colorBack:"#000000",colorFront:"#b2aeae",size:.6,radius:2,contrast:.01,originalColors:!0,inverted:!1,grainMixer:0,grainOverlay:0,grainSize:.5,grid:"hex",type:"classic"}},{name:"Round and square",params:{...i.defaultObjectSizing,fit:"cover",speed:0,frame:0,colorBack:"#141414",colorFront:"#ff8000",size:.8,radius:1,contrast:1,originalColors:!1,inverted:!0,grainMixer:.05,grainOverlay:.3,grainSize:.5,grid:"square",type:"holes"}}],eW=(0,t.memo)(function({speed:o=eN.params.speed,frame:a=eN.params.frame,colorFront:t=eN.params.colorFront,colorBack:r=eN.params.colorBack,image:l="",size:n=eN.params.size,radius:f=eN.params.radius,contrast:c=eN.params.contrast,originalColors:m=eN.params.originalColors,inverted:p=eN.params.inverted,grainMixer:d=eN.params.grainMixer,grainOverlay:g=eN.params.grainOverlay,grainSize:h=eN.params.grainSize,grid:v=eN.params.grid,type:_=eN.params.type,fit:x=eN.params.fit,scale:y=eN.params.scale,rotation:b=eN.params.rotation,originX:S=eN.params.originX,originY:C=eN.params.originY,offsetX:w=eN.params.offsetX,offsetY:k=eN.params.offsetY,worldWidth:z=eN.params.worldWidth,worldHeight:B=eN.params.worldHeight,...U}){let V={u_image:l,u_colorFront:(0,s.getShaderColorFromString)(t),u_colorBack:(0,s.getShaderColorFromString)(r),u_size:n,u_radius:f,u_contrast:c,u_originalColors:m,u_inverted:p,u_grainMixer:d,u_grainOverlay:g,u_grainSize:h,u_grid:ej[v],u_type:eD[_],u_fit:i.ShaderFitOptions[x],u_rotation:b,u_scale:y,u_offsetX:w,u_offsetY:k,u_originX:S,u_originY:C,u_worldWidth:z,u_worldHeight:B};return(0,u.jsx)(e.ShaderMount,{...U,speed:o,frame:a,fragmentShader:eX,uniforms:V})},r.colorPropsAreEqual),eG=`#version 300 es
precision mediump float;
...
`,eq={dots:0,ink:1,sharp:2},eH={name:"Default",params:{...i.defaultObjectSizing,scale:1,fit:"cover",speed:0,frame:0,colorBack:"#fbfaf5",colorC:"#00b4ff",colorM:"#fc519f",colorY:"#ffd800",colorK:"#231f20",size:.2,contrast:1,softness:1,grainSize:.5,grainMixer:0,grainOverlay:0,gridNoise:.2,floodC:.15,floodM:0,floodY:0,floodK:0,gainC:.3,gainM:0,gainY:.2,gainK:0,type:"ink"}},e$=[eH,{name:"Drops",params:{...i.defaultObjectSizing,scale:1,fit:"cover",speed:0,frame:0,colorBack:"#eeefd7",colorC:"#00b2ff",colorM:"#fc4f4f",colorY:"#ffd900",colorK:"#231f20",size:.88,contrast:1.15,softness:0,grainSize:.01,grainMixer:.05,grainOverlay:.25,gridNoise:.5,floodC:.15,floodM:0,floodY:0,floodK:0,gainC:1,gainM:.44,gainY:-1,gainK:0,type:"ink"}},{name:"Newspaper",params:{...i.defaultObjectSizing,scale:1,fit:"cover",speed:0,frame:0,colorBack:"#f2f1e8",colorC:"#7a7a75",colorM:"#7a7a75",colorY:"#7a7a75",colorK:"#231f20",size:.01,contrast:2,softness:.2,grainSize:0,grainMixer:0,grainOverlay:.2,gridNoise:.6,floodC:0,floodM:0,floodY:0,floodK:.1,gainC:-.17,gainM:-.45,gainY:-.45,gainK:0,type:"dots"}},{name:"Vintage",params:{...i.defaultObjectSizing,scale:1,fit:"cover",speed:0,frame:0,colorBack:"#fffaf0",colorC:"#59afc5",colorM:"#d8697c",colorY:"#fad85c",colorK:"#2d2824",size:.2,contrast:1.25,softness:.4,grainSize:.5,grainMixer:.15,grainOverlay:.1,gridNoise:.45,floodC:.15,floodM:0,floodY:0,floodK:0,gainC:.3,gainM:0,gainY:.2,gainK:0,type:"sharp"}}],eL=(0,t.memo)(function({speed:o=eH.params.speed,frame:a=eH.params.frame,colorBack:t=eH.params.colorBack,colorC:r=eH.params.colorC,colorM:n=eH.params.colorM,colorY:f=eH.params.colorY,colorK:c=eH.params.colorK,image:m="",size:p=eH.params.size,contrast:d=eH.params.contrast,softness:g=eH.params.softness,grainSize:h=eH.params.grainSize,grainMixer:v=eH.params.grainMixer,grainOverlay:_=eH.params.grainOverlay,gridNoise:x=eH.params.gridNoise,floodC:y=eH.params.floodC,floodM:b=eH.params.floodM,floodY:S=eH.params.floodY,floodK:C=eH.params.floodK,gainC:w=eH.params.gainC,gainM:k=eH.params.gainM,gainY:z=eH.params.gainY,gainK:B=eH.params.gainK,type:U=eH.params.type,fit:V=eH.params.fit,scale:O=eH.params.scale,rotation:F=eH.params.rotation,originX:M=eH.params.originX,originY:R=eH.params.originY,offsetX:I=eH.params.offsetX,offsetY:P=eH.params.offsetY,worldWidth:Y=eH.params.worldWidth,worldHeight:A=eH.params.worldHeight,...X}){let D={u_image:m,u_noiseTexture:(0,l.getShaderNoiseTexture)(),u_colorBack:(0,s.getShaderColorFromString)(t),u_colorC:(0,s.getShaderColorFromString)(r),u_colorM:(0,s.getShaderColorFromString)(n),u_colorY:(0,s.getShaderColorFromString)(f),u_colorK:(0,s.getShaderColorFromString)(c),u_size:p,u_contrast:d,u_softness:g,u_grainSize:h,u_grainMixer:v,u_grainOverlay:_,u_gridNoise:x,u_floodC:y,u_floodM:b,u_floodY:S,u_floodK:C,u_gainC:w,u_gainM:k,u_gainY:z,u_gainK:B,u_type:eq[U],u_fit:i.ShaderFitOptions[V],u_rotation:F,u_scale:O,u_offsetX:I,u_offsetY:P,u_originX:M,u_originY:R,u_worldWidth:Y,u_worldHeight:A};return(0,u.jsx)(e.ShaderMount,{...X,speed:o,frame:a,fragmentShader:eG,uniforms:D})},r.colorPropsAreEqual),eE=`#version 300 es
precision mediump float;
...
`;function eK(o){let e=document.createElement("canvas"),a=e.getContext("2d"),t="string"==typeof o&&o.startsWith("blob:");return new Promise((r,i)=>{if(!o||!a)return void i(Error("Invalid file or canvas context"));let s=t&&fetch(o).then(o=>o.headers.get("Content-Type")),l=new Image;l.crossOrigin="anonymous";let n=performance.now();l.onload=async()=>{let t,n=await s;t=n?"image/svg+xml"===n:"string"==typeof o?o.endsWith(".svg")||o.startsWith("data:image/svg+xml"):"image/svg+xml"===o.type;let f=l.width||l.naturalWidth,c=l.height||l.naturalHeight;if(t){let o=f/c;f>c?(f=4096,c=4096/o):(c=4096,f=4096*o),l.width=f,l.height=c}let u=512/Math.min(f,c),m=Math.round(f*u),p=Math.round(c*u);e.width=f,e.height=c;let d=Math.ceil(.025*m),g=Math.ceil(.025*p),h=m-2*d,v=p-2*g,_=document.createElement("canvas");_.width=m,_.height=p;let x=_.getContext("2d");x.drawImage(l,d,g,h,v);let y=performance.now(),b=x.getImageData(0,0,m,p).data,S=new Uint8Array(m*p),C=new Uint8Array(m*p),w=0;for(let o=0,e=0;o<b.length;o+=4,e++){let a=+(0!==b[o+3]);S[e]=a,w+=a}let k=[],z=[];for(let o=0;o<p;o++)for(let e=0;e<m;e++){let a=o*m+e;if(S[a])0!==e&&e!==m-1&&0!==o&&o!==p-1&&S[a-1]&&S[a+1]&&S[a-m]&&S[a+m]&&S[a-m-1]&&S[a-m+1]&&S[a+m-1]&&S[a+m+1]?z.push(a):(C[a]=1,k.push(a))}let B=function(o,e,a,t,r){let i=e.length,s=new Int32Array(4*i);for(let a=0;a<i;a++){let i=e[a],l=i%t,n=Math.floor(i/t);s[4*a+0]=l<t-1&&o[i+1]?i+1:-1,s[4*a+1]=l>0&&o[i-1]?i-1:-1,s[4*a+2]=n>0&&o[i-t]?i-t:-1,s[4*a+3]=n<r-1&&o[i+t]?i+t:-1}return{interiorPixels:e,boundaryPixels:a,pixelCount:i,neighborIndices:s}}(S,new Uint32Array(z),new Uint32Array(k),m,p),U=performance.now(),V=function(o,e,a){let t=new Float32Array(e*a),{interiorPixels:r,neighborIndices:i,pixelCount:s}=o,l=performance.now(),n=[],f=[];for(let o=0;o<s;o++){let a=r[o];(a%e+Math.floor(a/e))%2==0?n.push(o):f.push(o)}for(let o=0;o<32;o++){for(let o of n){let e=r[o],a=i[4*o+0],s=i[4*o+1],l=i[4*o+2],n=i[4*o+3],f=0;a>=0&&(f+=t[a]),s>=0&&(f+=t[s]),l>=0&&(f+=t[l]),n>=0&&(f+=t[n]);let c=(.01+f)/4;t[e]=1.9*c+-.8999999999999999*t[e]}for(let o of f){let e=r[o],a=i[4*o+0],s=i[4*o+1],l=i[4*o+2],n=i[4*o+3],f=0;a>=0&&(f+=t[a]),s>=0&&(f+=t[s]),l>=0&&(f+=t[l]),n>=0&&(f+=t[n]);let c=(.01+f)/4;t[e]=1.9*c+-.8999999999999999*t[e]}}let c=new Float32Array(e*a);for(let o=0;o<3;o++){c.set(t);for(let o=0;o<s;o++){let e=r[o],a=i[4*o+0],s=i[4*o+1],l=i[4*o+2],n=i[4*o+3],f=0,u=0;a>=0&&(f+=c[a],u++),s>=0&&(f+=c[s],u++),l>=0&&(f+=c[l],u++),n>=0&&(f+=c[n],u++),t[e]=u>0?(c[e]+f/u)*.5:c[e]}}0;return t}(B,m,p);let O=0;for(let o=0;o<z.length;o++){let e=z[o];V[e]>O&&(O=V[e])}let F=document.createElement("canvas");F.width=m,F.height=p;let M=F.getContext("2d"),R=M.createImageData(m,p);for(let o=0;o<p;o++)for(let e=0;e<m;e++){let a=o*m+e,t=4*a;if(S[a]){let o=255*(1-V[a]/O);R.data[t]=o,R.data[t+1]=o,R.data[t+2]=o,R.data[t+3]=255}else R.data[t]=255,R.data[t+1]=255,R.data[t+2]=255,R.data[t+3]=0}M.putImageData(R,0,0),a.imageSmoothingEnabled=!0,a.imageSmoothingQuality="high",a.drawImage(F,0,0,m,p,0,0,f,c);let I=a.getImageData(0,0,f,c),P=Math.ceil(.025*f),Y=Math.ceil(.025*c),A=document.createElement("canvas");A.width=f,A.height=c;let X=A.getContext("2d");X.drawImage(l,P,Y,f-2*P,c-2*Y);let D=X.getImageData(0,0,f,c);for(let o=0;o<I.data.length;o+=4){let e=D.data[o+3],a=I.data[o+3];0===e?(I.data[o]=255,I.data[o+1]=0):(I.data[o]=0===a?0:I.data[o],I.data[o+1]=e),I.data[o+2]=255,I.data[o+3]=255}a.putImageData(I,0,0),e.toBlob(o=>{if(!o)return void i(Error("Failed to create PNG blob"));0;r({imageData:I,pngBlob:o})},"image/png")},l.onerror=()=>i(Error("Failed to load image")),l.src="string"==typeof o?o:URL.createObjectURL(o)})}let eJ={none:0,circle:1,daisy:2,diamond:3,metaballs:4},eQ={name:"Default",params:{...i.defaultObjectSizing,scale:.6,speed:1,frame:0,colorBack:"#f0efea",colorInner:"#fafaf5",colors:["#333333","#e7e6df"],outerGlow:.55,innerGlow:1,innerDistortion:.8,outerDistortion:.6,offset:0,angle:0,size:.8,shape:"diamond"}},eZ={name:"Fluorescent",params:{...i.defaultObjectSizing,scale:.6,speed:1,frame:0,colorBack:"#000000",colorInner:"#000000",colors:["#2fb64c","#cdff61","#ffffff"],outerGlow:0,innerGlow:1,innerDistortion:1,outerDistortion:.8,offset:0,angle:0,size:.8,shape:"diamond"}},e0=[eQ,{name:"Fire",params:{...i.defaultObjectSizing,scale:.6,speed:1,frame:0,colorBack:"#000000",colorInner:"#000000",colors:["#fe5b16","#f7ff61","#ffffff"],outerGlow:1,innerGlow:.65,innerDistortion:.6,outerDistortion:.8,offset:0,angle:0,size:.8,shape:"diamond"}},eZ,{name:"Infrared",params:{...i.defaultObjectSizing,scale:.6,speed:.5,frame:0,colorBack:"#cd28dc",colorInner:"#00000000",colors:["#ff9900","#fff67a","#dcff52","#00ffbb","#0077ff"],outerGlow:1,innerGlow:1,innerDistortion:1,outerDistortion:1,offset:.2,angle:0,size:1,shape:"diamond"}}],e1=(0,t.memo)(function({colorBack:o=eQ.params.colorBack,colors:a=eQ.params.colors,speed:r=eQ.params.speed,frame:l=eQ.params.frame,image:n="",innerDistortion:f=eQ.params.innerDistortion,outerDistortion:c=eQ.params.outerDistortion,outerGlow:m=eQ.params.outerGlow,innerGlow:p=eQ.params.innerGlow,colorInner:d=eQ.params.colorInner,offset:g=eQ.params.offset,angle:h=eQ.params.angle,size:v=eQ.params.size,shape:_=eQ.params.shape,suspendWhenProcessingImage:x=!1,fit:y=eQ.params.fit,scale:b=eQ.params.scale,rotation:S=eQ.params.rotation,originX:C=eQ.params.originX,originY:w=eQ.params.originY,offsetX:k=eQ.params.offsetX,offsetY:z=eQ.params.offsetY,worldWidth:B=eQ.params.worldWidth,worldHeight:U=eQ.params.worldHeight,...V}){let O,F="string"==typeof n?n:n.src,[M,R]=(0,t.useState)(ez);O=x&&"u">typeof window&&F?eU(()=>eK(F).then(o=>URL.createObjectURL(o.pngBlob)),[F,"gemSmoke"]):M,(0,t.useLayoutEffect)(()=>{if(x)return;if(!F)return void R(ez);let o=!0;return eK(F).then(e=>{o&&R(URL.createObjectURL(e.pngBlob))}),()=>{o=!1}},[F,x]);let I={u_colors:a.map(s.getShaderColorFromString),u_colorsCount:a.length,u_colorBack:(0,s.getShaderColorFromString)(o),u_image:O,u_innerDistortion:f,u_outerDistortion:c,u_outerGlow:m,u_innerGlow:p,u_colorInner:(0,s.getShaderColorFromString)(d),u_offset:g,u_angle:h,u_size:v,u_isImage:!!n,u_shape:eJ[_],u_fit:i.ShaderFitOptions[y],u_scale:b,u_rotation:S,u_offsetX:k,u_offsetY:z,u_originX:C,u_originY:w,u_worldWidth:B,u_worldHeight:U};return(0,u.jsx)(e.ShaderMount,{...V,speed:r,frame:l,fragmentShader:eE,mipmaps:["u_image"],uniforms:I})},r.colorPropsAreEqual);var e2=o.i(87599),e5=o.i(45867),e3=o.i(68138);o.s([],29321),o.i(29321),o.s(["ColorPanels",0,oL,"Dithering",0,oY,"DotGrid",0,O,"DotOrbit",0,k,"FlutedGlass",0,ef,"GemSmoke",0,e1,"GodRays",0,og,"GrainGradient",()=>oA.GrainGradient,"HalftoneCmyk",0,eL,"HalftoneDots",0,eW,"Heatmap",0,eF,"ImageDithering",0,ey,"LiquidMetal",0,eA,"MeshGradient",()=>a.MeshGradient,"Metaballs",0,W,"NeuroNoise",0,x,"PaperTexture",0,ea,"PerlinNoise",0,J,"PulsingBorder",0,oW,"ShaderMount",()=>e.ShaderMount,"SimplexNoise",0,Y,"SmokeRing",0,g,"Spiral",0,oy,"StaticMeshGradient",0,o0,"StaticRadialGradient",0,o8,"Swirl",0,oz,"Voronoi",0,or,"Warp",0,oc,"Water",0,eg,"Waves",0,$,"colorPanelsMeta",0,oG,"colorPanelsPresets",0,o$,"ditheringPresets",0,oP,"dotGridPresets",0,V,"dotOrbitMeta",0,y,"dotOrbitPresets",0,w,"flutedGlassPresets",0,en,"gemSmokePresets",0,e0,"getShaderColorFromString",()=>s.getShaderColorFromString,"godRaysMeta",0,ou,"godRaysPresets",0,od,"grainGradientMeta",()=>e5.grainGradientMeta,"grainGradientPresets",()=>oA.grainGradientPresets,"halftoneCmykPresets",0,e$,"halftoneDotsPresets",0,eT,"heatmapMeta",0,eb,"heatmapPresets",0,eO,"imageDitheringPresets",0,ex,"isPaperShaderElement",()=>e2.isPaperShaderElement,"liquidMetalPresets",0,eY,"meshGradientMeta",()=>e3.meshGradientMeta,"meshGradientPresets",()=>a.meshGradientPresets,"metaballsMeta",0,A,"metaballsPresets",0,T,"neuroNoisePresets",0,_,"paperTexturePresets",0,ee,"perlinNoisePresets",0,K,"pulsingBorderMeta",0,oX,"pulsingBorderPresets",0,oT,"simplexNoiseMeta",0,F,"simplexNoisePresets",0,P,"smokeRingMeta",0,f,"smokeRingPresets",0,d,"spiralPresets",0,ox,"staticMeshGradientMeta",0,oE,"staticMeshGradientPresets",0,oZ,"staticRadialGradientMeta",0,o1,"staticRadialGradientPresets",0,o9,"swirlMeta",0,ob,"swirlPresets",0,ok,"voronoiMeta",0,Q,"voronoiPresets",0,ot,"warpMeta",0,oi,"warpPresets",0,of,"waterPresets",0,ed,"wavesPresets",0,H],49897)},59686,o=>{o.n(o.i(49897))}]);