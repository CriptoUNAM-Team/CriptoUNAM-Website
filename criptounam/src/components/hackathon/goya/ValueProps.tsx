...
const CAPACIDADES = [
  ...
  },
  {
    ...
    cuerpo:
      `${TOTAL_PREMIOS_PUMA.toLocaleString('es-MX')} $PUMA en AI (CriptoUNAM), $${TOTAL_PREMIOS_USD.toLocaleString('en-US')} USD en Stellar · Avalanche · Pollar · Contenido (Tangem). Aparte: 3 MoureDev Pro y aceleradora Instaward para ganadores Stellar.`,
    },
]
